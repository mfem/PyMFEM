...
def GetGlobalMPI_Comm():
    ...
    return _coefficient.GetGlobalMPI_Comm()
GetGlobalMPI_Comm = _coefficient.GetGlobalMPI_Comm

def SetGlobalMPI_Comm(comm):
    r"""SetGlobalMPI_Comm(MPI_Comm comm)"""
    return _coefficient.SetGlobalMPI_Comm(comm)
SetGlobalMPI_Comm = _coefficient.SetGlobalMPI_Comm
