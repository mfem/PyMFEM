...
class ParL2FaceRestriction(mfem._par.operators.Operator):
    ...
    def MultTranspose(self, x, y):
        r"""MultTranspose(ParL2FaceRestriction self, Vector x, Vector y)"""
        return _prestriction.ParL2FaceRestriction_MultTranspose(self, x, y)
    MultTranspose = _swig_new_instance_method(_prestriction.ParL2FaceRestriction_MultTranspose)
