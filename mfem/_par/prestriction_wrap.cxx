...
#define SWIGTYPE_p_mfem__ParL2FaceRestriction swig_types[37]
...
SWIGINTERN PyObject *_wrap_ParL2FaceRestriction_MultTranspose(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ParL2FaceRestriction_MultTranspose" "', argument " "3"" of type '" "mfem::Vector &""'"); 
  }
  arg3 = reinterpret_cast< mfem::Vector * >(argp3);
  {
    try {
      ((mfem::ParL2FaceRestriction const *)arg1)->MultTranspose((mfem::Vector const &)*arg2,*arg3); 
    }
    catch (Swig::DirectorException &e) {
      SWIG_fail; 
    }    
...
static void *_p_mfem__ParL2FaceRestrictionTo_p_mfem__Operator(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((mfem::Operator *)  ((mfem::ParL2FaceRestriction *) x));
}
