...
#define SWIGTYPE_p_mfem__BlockDiagonalPreconditioner swig_types[9]
#define SWIGTYPE_p_mfem__BlockLowerTriangularPreconditioner swig_types[10]
#define SWIGTYPE_p_mfem__BlockNonlinearForm swig_types[11]
#define SWIGTYPE_p_mfem__BlockOperator swig_types[12]
...
#define SWIGTYPE_p_mfem__ParBlockNonlinearForm swig_types[42]
#define SWIGTYPE_p_mfem__ParFiniteElementSpace swig_types[43]
#define SWIGTYPE_p_mfem__ParGridFunction swig_types[44]
#define SWIGTYPE_p_mfem__ParNonlinearForm swig_types[45]
...
#define SWIGTYPE_p_mfem__QuadratureFunction swig_types[49]
#define SWIGTYPE_p_mfem__RAPOperator swig_types[50]
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_ParNonlinearForm", _wrap_new_ParNonlinearForm, METH_VARARGS, (char *)"new_ParNonlinearForm(ParFiniteElementSpace pf) -> ParNonlinearForm"},
	 { (char *)"ParNonlinearForm_ParFESpace", _wrap_ParNonlinearForm_ParFESpace, METH_VARARGS, (char *)"ParNonlinearForm_ParFESpace(ParNonlinearForm self) -> ParFiniteElementSpace"},
	 { (char *)"ParNonlinearForm_GetParGridFunctionEnergy", _wrap_ParNonlinearForm_GetParGridFunctionEnergy, METH_VARARGS, (char *)"ParNonlinearForm_GetParGridFunctionEnergy(ParNonlinearForm self, Vector x) -> double"},
	 { (char *)"ParNonlinearForm_GetEnergy", _wrap_ParNonlinearForm_GetEnergy, METH_VARARGS, (char *)"\n"
		"GetEnergy(ParGridFunction x) -> double\n"
		"ParNonlinearForm_GetEnergy(ParNonlinearForm self, Vector x) -> double\n"
		""},
	 { (char *)"ParNonlinearForm_Mult", _wrap_ParNonlinearForm_Mult, METH_VARARGS, (char *)"ParNonlinearForm_Mult(ParNonlinearForm self, Vector x, Vector y)"},
	 { (char *)"ParNonlinearForm_GetLocalGradient", _wrap_ParNonlinearForm_GetLocalGradient, METH_VARARGS, (char *)"ParNonlinearForm_GetLocalGradient(ParNonlinearForm self, Vector x) -> SparseMatrix"},
	 { (char *)"ParNonlinearForm_GetGradient", _wrap_ParNonlinearForm_GetGradient, METH_VARARGS, (char *)"ParNonlinearForm_GetGradient(ParNonlinearForm self, Vector x) -> Operator"},
	 { (char *)"ParNonlinearForm_SetGradientType", _wrap_ParNonlinearForm_SetGradientType, METH_VARARGS, (char *)"ParNonlinearForm_SetGradientType(ParNonlinearForm self, mfem::Operator::Type tid)"},
	 { (char *)"ParNonlinearForm_Update", _wrap_ParNonlinearForm_Update, METH_VARARGS, (char *)"ParNonlinearForm_Update(ParNonlinearForm self)"},
	 { (char *)"delete_ParNonlinearForm", _wrap_delete_ParNonlinearForm, METH_VARARGS, (char *)"delete_ParNonlinearForm(ParNonlinearForm self)"},
	 { (char *)"ParNonlinearForm_swigregister", ParNonlinearForm_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_ParBlockNonlinearForm", _wrap_new_ParBlockNonlinearForm, METH_VARARGS, (char *)"\n"
		"ParBlockNonlinearForm()\n"
		"new_ParBlockNonlinearForm(mfem::Array< mfem::ParFiniteElementSpace * > & pf) -> ParBlockNonlinearForm\n"
		""},
	 { (char *)"ParBlockNonlinearForm_ParFESpace", _wrap_ParBlockNonlinearForm_ParFESpace, METH_VARARGS, (char *)"\n"
		"ParFESpace(int k) -> ParFiniteElementSpace\n"
		"ParBlockNonlinearForm_ParFESpace(ParBlockNonlinearForm self, int k) -> ParFiniteElementSpace\n"
		""},
	 { (char *)"ParBlockNonlinearForm_SetParSpaces", _wrap_ParBlockNonlinearForm_SetParSpaces, METH_VARARGS, (char *)"ParBlockNonlinearForm_SetParSpaces(ParBlockNonlinearForm self, mfem::Array< mfem::ParFiniteElementSpace * > & pf)"},
	 { (char *)"ParBlockNonlinearForm_SetEssentialBC", _wrap_ParBlockNonlinearForm_SetEssentialBC, METH_VARARGS, (char *)"ParBlockNonlinearForm_SetEssentialBC(ParBlockNonlinearForm self, mfem::Array< mfem::Array< int > * > const & bdr_attr_is_ess, mfem::Array< mfem::Vector * > & rhs)"},
	 { (char *)"ParBlockNonlinearForm_Mult", _wrap_ParBlockNonlinearForm_Mult, METH_VARARGS, (char *)"ParBlockNonlinearForm_Mult(ParBlockNonlinearForm self, Vector x, Vector y)"},
	 { (char *)"ParBlockNonlinearForm_GetLocalGradient", _wrap_ParBlockNonlinearForm_GetLocalGradient, METH_VARARGS, (char *)"ParBlockNonlinearForm_GetLocalGradient(ParBlockNonlinearForm self, Vector x) -> BlockOperator"},
	 { (char *)"ParBlockNonlinearForm_GetGradient", _wrap_ParBlockNonlinearForm_GetGradient, METH_VARARGS, (char *)"ParBlockNonlinearForm_GetGradient(ParBlockNonlinearForm self, Vector x) -> BlockOperator"},
	 { (char *)"ParBlockNonlinearForm_SetGradientType", _wrap_ParBlockNonlinearForm_SetGradientType, METH_VARARGS, (char *)"ParBlockNonlinearForm_SetGradientType(ParBlockNonlinearForm self, mfem::Operator::Type tid)"},
	 { (char *)"delete_ParBlockNonlinearForm", _wrap_delete_ParBlockNonlinearForm, METH_VARARGS, (char *)"delete_ParBlockNonlinearForm(ParBlockNonlinearForm self)"},
