...
#define SWIGTYPE_p_mfem__SparseSmoother swig_types[17]
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"SparseSmoother_SetOperator", _wrap_SparseSmoother_SetOperator, METH_VARARGS, (char *)"SparseSmoother_SetOperator(SparseSmoother self, Operator a)"},
	 { (char *)"delete_SparseSmoother", _wrap_delete_SparseSmoother, METH_VARARGS, (char *)"delete_SparseSmoother(SparseSmoother self)"},
	 { (char *)"SparseSmoother_swigregister", SparseSmoother_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_GSSmoother", _wrap_new_GSSmoother, METH_VARARGS, (char *)"\n"
		"GSSmoother(int t=0, int it=1)\n"
		"GSSmoother(int t=0)\n"
		"GSSmoother()\n"
		"GSSmoother(SparseMatrix a, int t=0, int it=1)\n"
		"GSSmoother(SparseMatrix a, int t=0)\n"
		"new_GSSmoother(SparseMatrix a) -> GSSmoother\n"
		""},
	 { (char *)"GSSmoother_Mult", _wrap_GSSmoother_Mult, METH_VARARGS, (char *)"GSSmoother_Mult(GSSmoother self, Vector x, Vector y)"},
	 { (char *)"delete_GSSmoother", _wrap_delete_GSSmoother, METH_VARARGS, (char *)"delete_GSSmoother(GSSmoother self)"},
	 { (char *)"GSSmoother_swigregister", GSSmoother_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_DSmoother", _wrap_new_DSmoother, METH_VARARGS, (char *)"\n"
		"DSmoother(int t=0, double s=1., int it=1)\n"
		"DSmoother(int t=0, double s=1.)\n"
		"DSmoother(int t=0)\n"
		"DSmoother()\n"
		"DSmoother(SparseMatrix a, int t=0, double s=1., int it=1)\n"
		"DSmoother(SparseMatrix a, int t=0, double s=1.)\n"
		"DSmoother(SparseMatrix a, int t=0)\n"
		"new_DSmoother(SparseMatrix a) -> DSmoother\n"
		""},
	 { (char *)"DSmoother_Mult", _wrap_DSmoother_Mult, METH_VARARGS, (char *)"DSmoother_Mult(DSmoother self, Vector x, Vector y)"},
	 { (char *)"delete_DSmoother", _wrap_delete_DSmoother, METH_VARARGS, (char *)"delete_DSmoother(DSmoother self)"},
