...
class SLISolver(IterativeSolver):
    ...
    def Mult(self, x, y):
        return _solvers_p.SLISolver_Mult(self, x, y)
...
class CGSolver(IterativeSolver):
    ...
    def Mult(self, x, y):
        return _solvers_p.CGSolver_Mult(self, x, y)
...
class GMRESSolver(IterativeSolver):
    ...
    def Mult(self, x, y):
        return _solvers_p.GMRESSolver_Mult(self, x, y)
...
class FGMRESSolver(IterativeSolver):
    ...
    def Mult(self, x, y):
        return _solvers_p.FGMRESSolver_Mult(self, x, y)
...
class BiCGSTABSolver(IterativeSolver):
    ...
    def Mult(self, x, y):
        return _solvers_p.BiCGSTABSolver_Mult(self, x, y)
