...
class FiniteElementSpace(_object):
    ...
    __swig_getmethods__["AdjustVDofs"] = lambda x: _fespace.FiniteElementSpace_AdjustVDofs
    if _newclass:
    ...
    def GetEssentialVDofs(self, bdr_attr_is_ess, ess_vdofs):
        return _fespace.FiniteElementSpace_GetEssentialVDofs(self, bdr_attr_is_ess, ess_vdofs)

    def GetEssentialTrueDofs(self, bdr_attr_is_ess, ess_tdof_list):
        return _fespace.FiniteElementSpace_GetEssentialTrueDofs(self, bdr_attr_is_ess, ess_tdof_list)
    __swig_getmethods__["MarkerToList"] = lambda x: _fespace.FiniteElementSpace_MarkerToList
    if _newclass:
        MarkerToList = staticmethod(_fespace.FiniteElementSpace_MarkerToList)
    __swig_getmethods__["ListToMarker"] = lambda x: _fespace.FiniteElementSpace_ListToMarker
    if _newclass:
