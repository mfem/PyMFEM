...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__sayhello

#else
#  define SWIG_init    init_sayhello

#endif
#define SWIG_name    "_sayhello"
...
SWIGINTERN PyObject *_wrap_sayhello(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:sayhello",&obj0,&obj1)) SWIG_fail;
  {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "sayhello" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  sayhello(arg1,arg2);
