...
SWIGINTERN PyObject *_wrap_ParFiniteElementSpace_GetProlongationMatrix(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_mfem__ParFiniteElementSpace, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ParFiniteElementSpace_GetProlongationMatrix" "', argument " "1"" of type '" "mfem::ParFiniteElementSpace *""'"); 
  }
  arg1 = reinterpret_cast< mfem::ParFiniteElementSpace * >(argp1);
  {
    try {
...
SWIGINTERN PyObject *_wrap_new_ConformingProlongationOperator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_ConformingProlongationOperator" "', argument " "1"" of type '" "mfem::ParFiniteElementSpace &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_ConformingProlongationOperator" "', argument " "1"" of type '" "mfem::ParFiniteElementSpace &""'"); 
  }
  arg1 = reinterpret_cast< mfem::ParFiniteElementSpace * >(argp1);
  {
    try {
      result = (mfem::ConformingProlongationOperator *)new mfem::ConformingProlongationOperator(*arg1); 
    }
    catch (Swig::DirectorException &e) {
      SWIG_fail; 
    }    
