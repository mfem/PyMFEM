...
class Poly_1D(_object):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.this = this
    __swig_getmethods__["Binom"] = lambda x: _fe.Poly_1D_Binom
    if _newclass:
    ...
    __swig_getmethods__["CalcBinomTerms"] = lambda x: _fe.Poly_1D_CalcBinomTerms
    if _newclass:
        CalcBinomTerms = staticmethod(_fe.Poly_1D_CalcBinomTerms)
    __swig_getmethods__["CalcDBinomTerms"] = lambda x: _fe.Poly_1D_CalcDBinomTerms
    if _newclass:
        CalcDBinomTerms = staticmethod(_fe.Poly_1D_CalcDBinomTerms)
    __swig_getmethods__["CalcBernstein"] = lambda x: _fe.Poly_1D_CalcBernstein
    if _newclass:
