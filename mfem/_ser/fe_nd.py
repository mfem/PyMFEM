...
class ND_R2D_SegmentElement(mfem._ser.fe_base.VectorFiniteElement):
    ...
    def Project(self, vc, Trans, dofs):
        r"""Project(ND_R2D_SegmentElement self, mfem::VectorCoefficient & vc, mfem::ElementTransformation & Trans, Vector dofs)"""
        return _fe_nd.ND_R2D_SegmentElement_Project(self, vc, Trans, dofs)
