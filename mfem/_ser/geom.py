...
class Geometry(_object):
    """Proxy of C++ mfem::Geometry class."""
    ...
    def GetCenter(self, GeomType):
        """GetCenter(Geometry self, int GeomType) -> IntegrationPoint"""
        return _geom.Geometry_GetCenter(self, GeomType)


    def GetRandomPoint(GeomType, ip):
        """GetRandomPoint(int GeomType, IntegrationPoint ip)"""
        return _geom.Geometry_GetRandomPoint(GeomType, ip)

    GetRandomPoint = staticmethod(GetRandomPoint)
    ...
    ProjectPoint = staticmethod(ProjectPoint)

    def GetGeomToPerfGeomJac(self, GeomType):
        """GetGeomToPerfGeomJac(Geometry self, int GeomType) -> DenseMatrix"""
    ...
    def JacToPerfJac(self, GeomType, J, PJ):
        """JacToPerfJac(Geometry self, int GeomType, DenseMatrix J, DenseMatrix PJ)"""
        return _geom.Geometry_JacToPerfJac(self, GeomType, J, PJ)


    def NumBdr(self, GeomType):
        """NumBdr(Geometry self, int GeomType) -> int"""
...
class RefinedGeometry(_object):
    """Proxy of C++ mfem::RefinedGeometry class."""
    ...
    def __init__(self, NPts, NRefG, NRefE, NBdrE=0):
        """
        __init__(mfem::RefinedGeometry self, int NPts, int NRefG, int NRefE, int NBdrE=0) -> RefinedGeometry
        __init__(mfem::RefinedGeometry self, int NPts, int NRefG, int NRefE) -> RefinedGeometry
        """
...
class GeometryRefiner(_object):
    """Proxy of C++ mfem::GeometryRefiner class."""
    ...
    def __init__(self):
        """__init__(mfem::GeometryRefiner self) -> GeometryRefiner"""
    ...
    def SetType(self, t):
        """SetType(GeometryRefiner self, int const t)"""
        return _geom.GeometryRefiner_SetType(self, t)


    def GetType(self):
        """GetType(GeometryRefiner self) -> int"""
