...
class VectorFEBoundaryTangentLFIntegrator(LinearFormIntegrator):
    ...
    def __init__(self, QG):
        r"""__init__(VectorFEBoundaryTangentLFIntegrator self, VectorCoefficient QG) -> VectorFEBoundaryTangentLFIntegrator"""
        _lininteg.VectorFEBoundaryTangentLFIntegrator_swiginit(self, _lininteg.new_VectorFEBoundaryTangentLFIntegrator(QG))
