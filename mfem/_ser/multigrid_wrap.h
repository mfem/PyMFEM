...
class SwigDirector_PyGeometricMultigrid : public mfem::PyGeometricMultigrid, public Swig::Director {

public:
    SwigDirector_PyGeometricMultigrid(PyObject *self, mfem::FiniteElementSpaceHierarchy const &fespaces_);
    ...
    virtual ~SwigDirector_PyGeometricMultigrid();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (!method) {
          std::string msg = "Method in class PyGeometricMultigrid doesn't exist, undefined ";
          msg += method_name;
