...
class OutStream(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, OutStream, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, OutStream, name)
    __repr__ = _swig_repr

    def __init__(self, out):
        this = _globals.new_OutStream(out)
        try:
...
OutStream_swigregister = _globals.OutStream_swigregister
OutStream_swigregister(OutStream)
