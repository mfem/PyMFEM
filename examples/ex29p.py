...
def run(order=3,
    ...
    print0("Size of linear system: " + str(A.Height()))

    # 11. Solve the linear system A X = B.
    #     Use a simple symmetric Gauss-Seidel preconditioner with HypreBoomerAMG
    ...
    print0("|u - u_h|_2 = " + "{:g}".format(err))

    flux_fespace = mfem.ParFiniteElementSpace(pmesh, fec, 3)
    flux = mfem.ParGridFunction(flux_fespace)
    ...
    print0("|f - f_h|_2 = " + "{:g}".format(flux_err))

    # 14. Save the refined mesh and the solution. This output can be viewed
    #     later using GLVis: "glvis -m refined.mesh -g sol.gf".
    pmesh.Print("mesh"+smyid, 8)
    x.Save("sol"+smyid, 8)
    flux.Save("flux"+smyid, 8)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-rp", "--refine-parallel",
                        ...
                        help="Number of times to refine the mesh uniformly (parallel).")
