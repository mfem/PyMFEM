...
matB0   =   B0.ParallelAssemble(); del B0
matBhat = Bhat.ParallelAssemble(); del Bhat
matSinv = Sinv.ParallelAssemble(); del Sinv
matS0   =   S0.ParallelAssemble(); del S0
...
#    and rhs.
x0_var = 0;  xhat_var = 1;  NVAR = 2  # enum in C
