...
ax1.legend()
plt.savefig('Example1c_fig1.pdf',format='pdf', bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Example1c_fig2.pdf',format='pdf', bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Example1c_fig3.pdf',format='pdf', bbox_inches='tight')
...
ax4.legend()
plt.savefig('Example1c_fig4.pdf',format='pdf', bbox_inches='tight')
...
ax5.legend()
plt.savefig('Example1c_fig5.pdf',format='pdf', bbox_inches='tight')
...
plt.savefig('Example1c_fig6.pdf',format='pdf', bbox_inches='tight')
