...
prob_config = {
    ...
    'tau_min'           : np.log2(2*(10**-3)),
    'M_warm'            : 50, # number of batches in warming phase
    'M_anneal'          : 50, # number of batches per tau in annealing phase
    'N_anneal'          : 2,  # number of target errors (tau) to train on
    'M_retrain'         : 5,  # number of batches for retraining before each new tau
...
config['exploration_config'] = {
   ...
   'action_space'       : action_space,
   'scale_schedule'     : schedule_object
   }
'''
print("Exploration config:")
