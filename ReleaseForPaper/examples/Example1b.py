...
if (restore_policy):
    ...
    temp_path = 'Example1b_2022-04-19_11-52-16'
...
if eval:
    ...
    if args.out_of_dist_eval:
        ood_dof_threshold = 5e5
        env.set_dof_threshold(ood_dof_threshold)
        print("*** Set out-of-distribution dof threshold of ", ood_dof_threshold)

    ## Enact trained policy with specified dof and error thresholds 
    ...
    ## Enact AMR policies with specified dof and error thresholds 
    costs = []
    actions = []
    nth = 100
    errors = []
    ...
    for i in range(1, nth):
        ...
        max_steps   = num_steps_of_RL_policy
        steps_taken = 0
        while not done:
