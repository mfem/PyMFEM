...
if train:
    ...
    checkpoint_path = "/Users/gillette7/ray_results/PPO_my_env_2022-02-04_11-06-078d84ga_n/checkpoint_000010/checkpoint-10"
...
ax4.legend()
plt.savefig('Example2c_fig4.pdf',format='pdf', bbox_inches='tight')
...
ax6.set_ylabel(r'$\theta$, $\rho$ in trained (AM)$^2$R policy')
plt.savefig('Example2c_fig6.pdf',format='pdf', bbox_inches='tight')
